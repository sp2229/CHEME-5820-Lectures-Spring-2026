...
Now thet we have a basic understanding of feedforward neural networks, let's see how they can be applied to a real-world problem: classifying images of handwritten digits from the MNIST dataset. 
